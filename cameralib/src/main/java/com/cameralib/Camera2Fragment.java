...
@SuppressLint("NewApi")
public class Camera2Fragment extends BasicCameraFragment
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new ImageSaver(Camera2Fragment.this, reader.acquireNextImage(), mFile));
        }
    ...
    public static BasicCameraFragment newInstance(String directoryPath) {
        BasicCameraFragment fragment = new Camera2Fragment();
